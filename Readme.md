...
<p>
  <em>Immutable Microblogging • On-Chain Messaging • Delegated Social Graph</em>
</p>
<p>
  TweeterContract is a decentralized engine for social interaction that migrates
...
<!-- Project 2 -->
<h4>💰 SimpleWallet – Ethereum Smart Contract</h4>
<p>
  <em>Secure Custodial Wallet • Transaction Logging • Circuit Breaker Pattern</em>
</p>
<p>
...
<ul>
  <li>🎨 NFT minting for stories, comics, and poems (ERC-721)</li>
  <li>💎 Transparent royalty distribution via smart contracts</li>
  <li>🌍 Decentralized storage using IPFS / Pinata</li>
  <li>🧩 Full-stack Web3 architecture with modern UI/UX</li>
</ul>

<p>
  <strong>Tech Stack:</strong><br/>
  Frontend: React.js, Next.js, Tailwind CSS, TypeScript<br/>
  Backend: Node.js, Express.js<br/>
  Blockchain: Solidity, Hardhat, Web3.js / Ethers.js<br/>
  Database: MongoDB Atlas<br/>
  Deployment: Vercel, Render, MetaMask
</p>

<p>
  🔗 <a href="https://github.com/sonisuryansh/GenIgnite-Hackathon-Problem-Statements" target="_blank">
    GitHub Repository
  </a>
</p>
...
<p align="center">
  <em>
    "Build systems that are transparent, scalable, and resilient —
    whether they run on a server, a container, or a blockchain."
  </em>
</p>
